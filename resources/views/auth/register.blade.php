            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nosim" class="col-md-4 col-form-label text-md-end">{{ __('No SIM') }}</label>

                            <div class="col-md-6">
                                <input id="nosim" type="text" class="form-control @error('nosim') is-invalid @enderror" name="nosim">
